...
**签名文案适配**：SKILL.md 的作者签名区（展示公众号卡片：`https://cdn.undsky.com/img/card_01_sketch_notes_raw_thumb.png`）放在本组件**之前**；本组件内部 `{{文末互动引导}}` 直接使用 SKILL.md 固定的第二段（"如果你觉得今天这篇有收获…我们下篇见"）。
