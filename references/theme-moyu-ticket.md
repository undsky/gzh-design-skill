...
**签名文案适配**：SKILL.md 的作者签名区（展示公众号卡片：`https://cdn.undsky.com/img/card_01_sketch_notes_raw_thumb.png`）放在本组件**之前**；本组件内部 `{{互动文案}}` 直接使用 SKILL.md 固定的第二段（"如果你觉得今天这篇有收获…我们下篇见"）。
...
<section style="padding:0 0 32px;">
  <section style="background:#fffef8;border:2px solid #1a1a1a;box-shadow:4px 4px 0 #1a1a1a;padding:24px 20px;text-align:center;">
    ...
    <section style="display:flex;justify-content:center;gap:16px;margin-bottom:16px;flex-wrap:wrap;">
